...
if __name__ == "__main__":
    ...
    #target_raw = o3d.io.read_point_cloud(os.path.join(dir_path,'kitti')+'/3d/oyla_'+str(200).zfill(4)+'.xyz',format='xyz')
    source_raw = o3d.io.read_point_cloud("/Users/rsingh/Downloads/cloud_bin_0.pcd")
    target_raw = o3d.io.read_point_cloud("/Users/rsingh/Downloads/cloud_bin_1.pcd")
